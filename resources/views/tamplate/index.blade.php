...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html">DN Music Player </a>
        ...
        <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2014 Dwi Nenda Putri - EGrappler.com </b>All rights reserved.
            </div>
        </div>
